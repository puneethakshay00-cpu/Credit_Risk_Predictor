...
encoders = {col: joblib.load(f"{col}_encoder.pkl") for col in ["Sex","Housing","Checking account","Saving accounts","Purpose"]}

st.title("Credit Risk Predictor")
st.write("Enter applicant information to predict if the credit risk is low or high")
...
if st.button("Predict Risk"):
    ...
    if pred == 1:
        st.success("The predicted credit risk is: **Low**")
    else:
        st.error("The predicted credit risk is: **High**")